...
class ConversationManager:
    ...
    def process_response(self, call_sid, script, user_input):
        ...
        if matched_response and 'extract_info' in responses.get(matched_response, {}):
            ...
            for field, pattern in extraction_patterns.items():
                ...
                if matches:
                    ...
                    print(f"Extracted {field}: {matches.group(1)}")
        ...
        if not next_stage:
            import random
            fallbacks = script.get('fallback_responses', ["I'm sorry, I didn't understand that."])
            return {
